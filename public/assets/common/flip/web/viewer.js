...
'use strict';
var brochure    = $('#brochure-id').val().trim();
var DEFAULT_URL =  brochure;
...
PDFJS.workerSrc = 'assets/common/flip/build/pdf.worker.js';
PDFJS.cMapUrl = 'assets/common/flip/web/cmaps/';
