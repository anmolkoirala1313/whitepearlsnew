! function() {
    ...
    function b() {
        var o, e, t = document.documentElement.getAttribute("data-layout"),
            ...
            a = JSON.parse(a);
        !a || "twocolumn" != t && "twocolumn" != a["data-layout"] || (document.querySelector(".navbar-menu").innerHTML = i, (o = document.createElement("ul")).innerHTML = '<a href="/auth/dashboard" class="logo"><img src="/assets/backend/images/canosoft-favicon.png" alt="" height="25"></a>', document.getElementById("navbar-nav").querySelectorAll(".menu-link").forEach(function(e) {
    ...
    function v() {
        document.addEventListener("DOMContentLoaded", function() {
            ...
            var e;
            ("twocolumn" == document.documentElement.getAttribute("data-layout") ? w : S)(), (e = document.getElementsByClassName("vertical-overlay")) && e.forEach(function(e) { e.addEventListener("click", function() { document.body.classList.remove("vertical-sidebar-enable"), "twocolumn" == sessionStorage.getItem("data-layout") ? document.body.classList.add("twocolumn-panel") : document.documentElement.setAttribute("data-sidebar-size", sessionStorage.getItem("data-sidebar-size")) }) }), k()
    ...
    function A(e) { "vertical" == e ? (document.getElementById("two-column-menu").innerHTML = "", document.querySelector(".navbar-menu").innerHTML = i, (document.getElementById("sidebar-size").style.display = "block", document.getElementById("sidebar-view").style.display = "block", document.getElementById("sidebar-color").style.display = "block", document.getElementById("layout-position").style.display = "block", document.getElementById("layout-width").style.display = "block"), f(), S(), k()) : "horizontal" == e ? (L(), document.getElementById("theme-settings-offcanvas") && (document.getElementById("sidebar-size").style.display = "none", document.getElementById("sidebar-view").style.display = "none", document.getElementById("sidebar-color").style.display = "none", document.getElementById("layout-position").style.display = "block", document.getElementById("layout-width").style.display = "block"), S()) : "twocolumn" == e && (document.getElementById("scrollbar").removeAttribute("data-simplebar"), document.getElementById("scrollbar").classList.remove("h-100"), document.getElementById("theme-settings-offcanvas") && (document.getElementById("sidebar-size").style.display = "none", document.getElementById("sidebar-view").style.display = "none", document.getElementById("sidebar-color").style.display = "block", document.getElementById("layout-position").style.display = "none", document.getElementById("layout-width").style.display = "none")) }

    function k() { document.getElementById("vertical-hover").addEventListener("click", function() { "sm-hover" === document.documentElement.getAttribute("data-sidebar-size") ? document.documentElement.setAttribute("data-sidebar-size", "sm-hover-active") : (document.documentElement.getAttribute("data-sidebar-size"), document.documentElement.setAttribute("data-sidebar-size", "sm-hover")) }) }
    ...
    function T() { document.webkitIsFullScreen || document.mozFullScreen || document.msFullscreenElement || document.body.classList.remove("fullscreen-enable") }

    // function q() {
    //     var t = 0;
    //     document.getElementsByClassName("cart-item-price").forEach(function(e) { t += parseFloat(e.innerHTML) }), document.getElementById("cart-item-total").innerHTML = "$" + t.toFixed(2)
    // }

    function C() { var e; "horizontal" !== document.documentElement.getAttribute("data-layout") && (!document.getElementById("navbar-nav") || (e = new SimpleBar(document.getElementById("navbar-nav"))) && e.getContentElement(), !document.getElementsByClassName("twocolumn-iconview")[0] || (e = new SimpleBar(document.getElementsByClassName("twocolumn-iconview")[0])) && e.getContentElement(), clearTimeout(l)) }
    ...
    document.getElementById("reset-layout") && document.getElementById("reset-layout").addEventListener("click", function() { sessionStorage.clear(), window.location.reload() }), document.querySelectorAll("[data-toast]").forEach(function(a) {
        ...
        function() {
            ...
            e && e.forEach(function(t) { t.addEventListener("click", function(e) { u(t.getAttribute("data-lang")) }) })
        }(), g(), window.addEventListener("resize", function() { l && clearTimeout(l), l = setTimeout(C, 2e3) })
}();
