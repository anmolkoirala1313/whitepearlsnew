...
use App\Http\Requests\Backend\News\NoticeRequest;
...
class NoticeController extends BackendBaseController
{
    ...
    protected string $base_route    = 'backend.news.notice.';
    protected string $view_path     = 'backend.news.notice.';
    protected string $page          = 'Notice';
