<tr>
    ...
    <td>
        <button type="button" title="Remove Image Detail Card"
                class="btn btn-outline-danger waves-effect waves-light remove_image_detail"><i class="ri-delete-bin-6-line"></i></button>
    </td>
</tr>
