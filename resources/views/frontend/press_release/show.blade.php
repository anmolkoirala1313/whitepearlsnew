                        ...
                        <div class="row mt-45 mb-60">
                            <div class="col-md-4">
                                <div class="blog__details-left-share">
                                    <h6>Share:</h6>
                                    <ul>
                                        <li><a href="#" target="_blank"><i class="fab fa-facebook-f" onclick='fbShare("{{route('frontend.press_release.show',$data['row']->slug)}}")'></i></a></li>
                                        <li><a href="#" target="_blank"><i class="fab fa-twitter" onclick='twitShare("{{route('frontend.press_release.show',$data['row']->slug)}}","{{ $data['row']->title }}")'></i></a></li>
                                        <li><a href="#" target="_blank"><i class="fab fa-whatsapp" onclick='whatsappShare("{{route('frontend.press_release.show',$data['row']->slug)}}","{{ $data['row']->title }}")'></i></a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
