        ...
        <div class="container">
            <div class="row">
                <div class="col-xl-8 col-lg-8 lg-mb-50">
                    <div class="row">
                        <h5>We found: <span class="text-primary">{{ count($data['rows']) }} Blog{{ count($data['rows']) > 1 ?'s':'' }}</span> </h5>
                        @foreach( $data['rows']  as $index=>$row)
                            <div class="col-xl-6 col-lg-6 {{ $index > 1 ? 'mt-4':'' }} d-flex align-items-stretch">
